...
MANIFEST_SUMMARY_TXT = Path(
    r"C:\realDesktop\manifest-evaluations\summer-26\custom-app-evaluation\manifest-evaluation\manifest-scan-results\manifest_only_summary_2026-06-11_16-38-20.txt"
)
